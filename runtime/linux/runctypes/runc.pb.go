...
type CreateOptions struct {
	...
	NoRootfsMount       bool     `protobuf:"varint,12,opt,name=no_rootfs_mount,json=noRootfsMount,proto3" json:"no_rootfs_mount,omitempty"`
}
...
func (this *CreateOptions) String() string {
	...
	s := strings.Join([]string{`&CreateOptions{`,
		...
		`NoRootfsMount:` + fmt.Sprintf("%v", this.NoRootfsMount) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *CreateOptions) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NoRootfsMount", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorRunc = []byte{
	...
	,
}
